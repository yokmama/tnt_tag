...
**自動開始**: 最小プレイヤー数（デフォルト4人）が揃うと自動的にカウントダウンが始まります。
...
1. **ロビー待機**: プレイヤーが集まるまで待機
2. **カウントダウン**: 10秒のカウントダウン
3. **ラウンド1-6**: 各ラウンドでTNTの押し付け合い
   - ラウンド開始時に全員中央にテレポート
   - TNT保持者がランダムに選出
...
| コマンド | 説明 | 権限 |
|---------|------|------|
| `/tnttag join [arena]` | ゲームに参加 | なし |
| `/tnttag leave` | ゲームから退出 | なし |
